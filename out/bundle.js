	    ...
	    _createClass(TodoHeader, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('input', { onKeyUp: this.handlerKeyUp.bind(this), type: 'text', placeholder: '请输入你的任务' })
	            );
	        }
	    }]);
